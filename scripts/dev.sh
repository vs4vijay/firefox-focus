...
function show_help() {
    ...
    echo ""
    echo "Configuration Commands (use ./scripts/config.sh):"
    echo "  ./scripts/config.sh show    # Show current configuration"
    echo "  ./scripts/config.sh set 22.04  # Switch to Ubuntu 22.04"
    echo "  ./scripts/config.sh jobs 4   # Set build job count"
    echo "  ./scripts/config.sh reset   # Reset to defaults"
    echo "  ./scripts/config.sh apply   # Apply config to shell"
    echo ""
    echo "Examples:"
